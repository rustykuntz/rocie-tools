...
Evaluation scenarios for testing the Meeting Intelligence skill across different Rocie models.

## Purpose

These evaluations ensure the Meeting Intelligence skill:
- Gathers context from Notion workspace
- Enriches with Rocie research appropriately
- Creates both internal pre-reads and external agendas
- Distinguishes between Notion facts and Rocie insights
...
- Enriches with Rocie research (decision frameworks, migration best practices)
- Creates comprehensive internal pre-read with recommendation
- Creates clean, professional external agenda
- Clearly distinguishes Notion facts from Rocie insights
...
- Adds Rocie context (industry benchmarks, best practices)
...
3. Verify the skill searches Notion first (not Rocie research)
4. Check that TWO documents are created (internal + external)
5. Verify Rocie enrichment adds value without replacing Notion content
...
4. **Verify enrichment value** - Is Rocie research genuinely helpful?
...
- "Rocie enrichment includes decision frameworks or best practices"
