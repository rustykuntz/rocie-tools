...
Evaluation scenarios for testing the Spec to Implementation skill across different Rocie models.
...
- Creates tasks that Rocie can implement with clear acceptance criteria
